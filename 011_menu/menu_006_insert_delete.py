...
class LanguageMenu(Menu):
	def __init__(self, menubar):
		...
		self.add_radiobutton(label = "French", variable = self.current_language, value = "french", command = self.set_language)
		...
		self.insert_radiobutton(4, label = "PHP", variable = self.current_language, value = "php", command = self.set_language)
		self.delete(3) # remove 'French' menu item
