# Here, the pop-up menu only works with the first Entry.
from tkinter import *
...
class MainFrame(ttk.Frame):
	def __init__(self, window):
		...
		self.grid()
		# populate
		entry_one = StringEntry(self, window)
		entry_one.bind("<Button-3>", entry_one.popup)
...
class StringEntry(ttk.Entry):
	def __init__(self, parent, window = None):
		...
		if window != None:
			self.popup_menu = PopUpMenu(window)
		# configure
