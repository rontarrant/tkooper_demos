...
class MainFrame(ttk.Frame):
	def __init__(self, window):
		...
		# layout
		simple_label_01.grid(row = 0, column = 0, ipadx = 10, ipady = 10)
		simple_label_02.grid(row = 1, column = 0, ipadx = 10, ipady = 10)
		simple_label_03.grid(row = 2, column = 0, ipadx = 10, ipady = 10)
		simple_label_04.grid(row = 0, column = 1, ipadx = 10, ipady = 10)
		simple_label_05.grid(row = 1, column = 1, ipadx = 10, ipady = 10)
		simple_label_06.grid(row = 2, column = 1, ipadx = 10, ipady = 10)
