...
class MainFrame(ttk.Frame):
	def __init__(self, window):
		...
		# configure
		self.grid()
		self.columnconfigure(0, minsize = 92)
		self.columnconfigure(1, minsize = 92)
		self.columnconfigure(2, minsize = 92)
		...
		# layout
		quit_button.grid(column = 1, row = 1, sticky = None)
